...
abstract class UplandsSaplingGenerator {
  def generate(iWorld_1: IWorld, blockPos_1: BlockPos, blockState_1: BlockState, random_1: Random): Boolean = {
    ...
    if (abstractTreeFeature_1 == null) false
      ...
      if (abstractTreeFeature_1.generate(iWorld_1, iWorld_1.getChunkManager.asInstanceOf[ServerChunkManager].getChunkGenerator, random_1, blockPos_1,
...
object UplandsSaplingGenerator {
  ...
  object SkyrootSaplingGenerator extends UplandsSaplingGenerator {
