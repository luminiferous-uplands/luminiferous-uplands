...
public final class BlockRegistry {
	...
	// Skyroot
	public static final Block SKYROOT_LOG = registerWithItem("skyroot_log", new LogBlock(MaterialColor.BROWN, SKYROOT_BLOCK_SETTINGS));
	public static final Block SKYROOT_WOOD = registerWithItem("skyroot_wood", new LogBlock(MaterialColor.WOOD, SKYROOT_BLOCK_SETTINGS));
