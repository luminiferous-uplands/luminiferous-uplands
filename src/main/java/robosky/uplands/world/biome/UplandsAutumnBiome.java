...
public class UplandsAutumnBiome extends Biome implements UplandsBiome {
    ...
    protected UplandsAutumnBiome() {
        super(new Biome.Settings().configureSurfaceBuilder(BiomeRegistry.UPLANDS_AUTUMN_SURFACE_BUILDER,
            BiomeRegistry.UPLANDS_GRASS_DIRT_STONE_SURFACE).precipitation(Biome.Precipitation.NONE).category(Category.FOREST)
