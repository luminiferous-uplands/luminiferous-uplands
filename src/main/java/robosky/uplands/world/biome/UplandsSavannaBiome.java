...
public class UplandsSavannaBiome extends Biome implements UplandsBiome {
    ...
    protected UplandsSavannaBiome() {
        ...
        addFeature(GenerationStep.Feature.VEGETAL_DECORATION, FeatureRegistry.FLAT_SKYROOT_TREE.configure(FeatureConfig.DEFAULT)
            .decorate(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraDecoratorConfig(0, 0.75f, 1))));
        ...
        addFeature(GenerationStep.Feature.VEGETAL_DECORATION, FeatureRegistry.TALL_UPLANDS_GRASS.configure(
            ...
            .decorate(Decorator.COUNT_HEIGHTMAP_DOUBLE.configure(new CountDecoratorConfig(4))));
