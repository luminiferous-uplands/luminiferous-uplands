...
//import robosky.uplands.mixin.ChunkGeneratorAccessor;
...
//
//public class UplandsChunkGenerator extends ChunkGenerator {
//
//    public static final Codec<UplandsChunkGenerator> CODEC = RecordCodecBuilder.create(instance -> instance.group(
//        BiomeSource.CODEC.fieldOf("biome_source").forGetter(ChunkGenerator::getBiomeSource),
//        Codec.LONG.fieldOf("seed").stable().forGetter((generator) -> ((ChunkGeneratorAccessor)generator).getWorldSeed()),
//        ChunkGeneratorSettings.REGISTRY_CODEC.fieldOf("settings").forGetter((generator) -> () -> generator.settings)
//    ).apply(instance, instance.stable((src, seed, settings) -> new UplandsChunkGenerator(src, seed, settings.get()))));
//
...
//
//    public UplandsChunkGenerator(BiomeSource biomeSource, long seed, ChunkGeneratorSettings settings) {
////        super(world, biomeSource, 8, 8, 256, new UplandsChunkGenConfig(), true);
//        super(biomeSource, biomeSource, settings.getStructuresConfig(), seed);
//        this.random = new ChunkRandom(seed);
//        this.random.consume(2620);
//        this.settings = settings;
//        this.depthNoiseSampler = new OctavePerlinNoiseSampler(this.random, Arrays.asList(15, 0));
//        this.falloffNoise = new OpenSimplexNoise(this.random.nextLong());
//        this.lowerInterpolationNoise = new OctavePerlinNoiseSampler(this.random, Arrays.asList(15, 0));
//        this.upperInterpolationNoise = new OctavePerlinNoiseSampler(this.random, Arrays.asList(15, 0));
//        this.interpolationNoise = new OctavePerlinNoiseSampler(this.random, Arrays.asList(7, 0));
//    }
//
//    @Override
...
//        return new UplandsChunkGenerator(this.biomeSource.withSeed(seed), seed, this.settings);
//    }
//
...
//                double e = this.depthNoiseSampler.sample((double)o * 0.0625D, (double)p * 0.0625D, 0.0625D, (double)m * 0.0625D) * 15.0D;
//                region.getBiome(mutable.set(k + m, q, l + n)).buildSurface(chunkRandom, chunk, o, p, q, e, this.settings.getDefaultBlock(), this.settings.getDefaultFluid(), this.getSeaLevel(), region.getSeed());
//            }
//        }
//    }
//
